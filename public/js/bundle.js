    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status == 'success') {
            (0, _alert.showAlert)('success', 'Signup in successfully!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('err', 'Error logging out! Try again.');
        case 10:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhpcnVtYWxhLXJhbyIsImEiOiJjbGtkbGYyMzUwbmU0M2xwbWszZWxncWs5In0.fEf7Zx4Opy6Aha622sxAQQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/thirumala-rao/clkdn3xps003401nybtd80mzp',
    scrollZoom: false
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable*/
var stripe = Stripe('pk_test_51Nyg96SFreGyZNU6vfpzlMP8w6o28PyL4HbCulcjhrzDpe8xYg0gNvr9cLcTmubk9fd1IeYUXKEUYtlVn9ksDWpV00tcck32lG');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    if (password !== passwordConfirm) {
      (0, _alert.showAlert)('error', 'passwords does not matched');
    } else {
